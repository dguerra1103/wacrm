...
# Native HEALTHCHECK (not just the one in docker-compose.yml) so
# platforms that build straight from this Dockerfile — Easypanel,
# Coolify, plain `docker run` — get container health without Compose.
